import 'package:Finalproject/medicinealarm_helper.dart';
...
class medicineAlarmPage extends StatefulWidget {
  @override
  _medicineAlarmPageState createState() => _medicineAlarmPageState();
...
class _medicineAlarmPageState extends State<medicineAlarmPage> {
  ...
  medicineAlarmHelper _alarmHelper = medicineAlarmHelper();
                                        ...
                                        builder: (context, setModalState) {
                                          return Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Flexible(child: Text('吃藥時間',style: TextStyle(fontSize: 32),)),
                                                Flexible(child: Text('   ')),
  ...
  void scheduleAlarm(
    ...
    //await flutterLocalNotificationsPlugin.periodicallyShow(0, '提醒', '吃藥時間到了',
