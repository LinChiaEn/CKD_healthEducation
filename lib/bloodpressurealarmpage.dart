import 'package:Finalproject/bloodpressurealarm_helper.dart';
...
class bloodpressureAlarmPage extends StatefulWidget {
  @override
  _bloodpressureAlarmPageState createState() => _bloodpressureAlarmPageState();

}

class _bloodpressureAlarmPageState extends State<bloodpressureAlarmPage> {

  TextEditingController event = TextEditingController();
  DateTime? _alarmTime;
  String? _alarmTimeString;
  bloodpressureAlarmHelper _alarmHelper = bloodpressureAlarmHelper();
                                        ...
                                        builder: (context, setModalState) {
                                          return Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Flexible(child: Text('量血壓時間',style: TextStyle(fontSize: 32),)),
                                                Flexible(child: Text('   ')),
  ...
  void scheduleAlarm(
    ...
    //await flutterLocalNotificationsPlugin.schedule(0, '提醒', '量血壓時間到了',
